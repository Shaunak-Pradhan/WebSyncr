...
namespace DevPortal.Services.Implementation
{
    public class TemplateService : ITemplateService
    {
        ...
        public static List<Template> GetNames()
        {
            ...
            Template.Add(new Template { ID = 1, Name = "Test", HTML = "" });
        ...
        {
            Template[] TemplateObjs = GetNames().ToArray();
            string TemplateName = TemplateObjs[TemplateID].Name;
            Placeholderdto placeholderdto = new Placeholderdto();
            placeholderdto.TemplateName = "Template 1";
            placeholderdto.Title = DisplayName;
            placeholderdto.Heading1 = "Websyncr";
            placeholderdto.Heading2 = "SIMPLE WEB PAGE";
            placeholderdto.Paragraph1 = "This is Using Simple HTML Code By Websyncr";
            ...
            Template[0] = "";
            Template[2] = DefaultTemplate(placeholderdto);
            Template[1] = Template1(placeholderdto);
            Template[3] = "<html> <head> <meta charset='utf-8'> <title>" + DisplayName + "</title> </head> <font color='#A6ACAF' size='5'> <marquee><b><i>This is template 2</i></b></marquee> </font> <body background='' link='white' alink='blue' vlink='#F8F8FF' > //background image <br /> <font face='Lato' size='5'><img src='CUsers\vijayakumarPictureslogo.jpg' height='50px' width='100px'></font>//logo image <font face='cinzel' size='4'> <a href='#'>HOME</a> &n bsp; &nbs p; <a href='#'>VIDEOS</a> <a href='#'>ARTICLES</a> <a href='#'>BLOG</a> <a href='#'>ABOUT US</a> </font> <br /><br /><br /><br /> <br /> <br /> <h1 align='center'> <font color='#F0B27A' size='9' id='heading'> WELCOME TO WEB PAGE<br/> </font> SIMPLE WEB PAGE </h1> <h3 align='center'> <font face='Lato' color='red' size='3'> Onyly Using Simple HTML Code </font> <br /><br /><br /><br /><br /><br/><br/><br/><br/> <hr width='1500px'> <footer id='footer'><center> <b> <font face='cinzel' size='4'> <a href ='#'>About Us| <a href ='#'>Contact Us | <a href ='#'> Privacy Policy | <a href ='#'> Terms | <a href ='#'>Media Kit | <a href ='#'> Sitemap | <a href ='#'> Report a Bug | <a href ='#'> FAQ Partners</a><br/> <a href ='#'>C# Tutorials| <a href ='#'> Common Interview Questions| <a href ='#'> Stories | <a href ='#'>Consultants | <a href ='#'> Ideas | <a href ='#'> Certifications </a><br/><br/> <font color='#FF0000'>all@copyrights 2020</font> </font> </b> </center></footer> </body> </html>";
        ...
        private string DefaultTemplate(Placeholderdto data)
        {
            return $@"<html>
                       ...
                       <font color='#A6ACAF' size='5'>
                          <marquee><b id='1Header'><i>{data.Heading1}</i></b></marquee>
                       </font>
                       <body background='' link='white' alink='blue' vlink='#F8F8FF' >
                          ...
                          <h1 align='center'> <font color='#F0B27A' size='9' id='heading'> WELCOME TO WEB PAGE<br/> </font>{data.Heading2} </h1>
                          <h3 align='center'>
                          <font face='Lato' color='red' size='3'>{data.Paragraph1}</font> <br /><br /><br /><br /><br /><br/><br/><br/><br/> 
                          <hr width='1500px'>
                          <footer id='footer'>
                             <center> {data.HTML} </center>
                          </footer>
                       </body>
                    </html>";
        }
        private string Template1(Placeholderdto data)
        {
                    ...
                    <html style='font-size: 16px;' lang='en'>
                       ...
                       <body data-home-page='Home.html' data-home-page-title='Home' class='u-body u-xl-mode' data-lang='en'>
                                   ...
                                   <div class='u-layout-row'>
                                      ...
                                      <div class='u-align-left u-container-align-center-md u-container-align-center-sm u-container-align-center-xs u-container-align-left-lg u-container-align-left-xl u-container-style u-layout-cell u-size-19-xl u-size-22-lg u-size-60-md u-size-60-sm u-size-60-xs u-layout-cell-2' data-animation-name='customAnimationIn' data-animation-duration='1500' data-animation-delay='0'>
                                         <div class='u-container-layout u-valign-middle u-container-layout-2'>
                                            <h2 class='u-align-center-md u-align-center-sm u-align-center-xs u-align-left-lg u-align-left-xl u-text u-text-1'> Wanna work <br>with us? </h2>
                                      ...
                                      <div class='u-layout-row'>
                                         ...
                                         <div class='u-container-align-left-xs u-container-style u-layout-cell u-size-34-md u-size-34-sm u-size-34-xs u-size-40-lg u-size-40-xl u-white u-layout-cell-2' data-animation-name='customAnimationIn' data-animation-duration='1500'>
                                            <div class='u-container-layout u-valign-bottom-xs u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-container-layout-2'>
                                               <h5 class='u-align-left-xs u-text u-text-default u-text-1'> We realize that you lead a busy life, so we have made it easy for you to drop off your vehicle 24/7. </h5>
                                               <p class='u-text u-text-default u-text-2'>Image from <a href='https://nicepage.best' class='u-active-none u-border-1 u-border-active-palette-2-base u-border-grey-75 u-border-hover-palette-2-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-1' data-animation-name='' data-animation-duration='0' data-animation-delay='0' data-animation-direction=''>Freepik</a> </p>
                          ...
                          <section class='u-align-center u-black u-clearfix u-valign-bottom-xl u-section-3' id='carousel_4c15'>
                             <h2 class='u-text u-text-default u-text-1' data-animation-name='customAnimationIn' data-animation-duration='1500' data-animation-delay='500'>Contact Us</h2>
            ...
            //                <link rel='stylesheet' href='/Resource/{data.TemplateName}/nicepage.css' media='screen'>
            //                <link rel='stylesheet' href='/Resource/{data.TemplateName}/Home.css' media='screen'>
            //                <script class='u-script' type='text/javascript' src='/Resource/{data.TemplateName}/jquery.js' defer=''></script> 
            //                <script class='u-script' type='text/javascript' src='/Resource/{data.TemplateName}/nicepage.js' defer=''></script>
            //                <meta name='generator' content='Nicepage 5.12.7, nicepage.com'>
            //                <link id='u-theme-google-font' rel='stylesheet' href='{data.GoogleFontLink}'>
            ...
            //                <meta data-intl-tel-input-cdn-path='intlTelInput/'>
            //            </head>
            //            <body data-home-page='{data.HomePage}' data-home-page-title='{data.HomePageTitle}' class='{data.BodyClass}' data-lang='{data.Language}'>
            //                                  <header class='u-clearfix u-header u-header' id='sec-edb7'>
            //                                     <div class='u-clearfix u-sheet u-valign-middle u-sheet-1'>
            //                                        <a href='https://nicepage.com' class='u-image u-logo u-image-1'> <img src='/Resource/{data.TemplateName}/images/default-logo.png' class='u-logo-image u-logo-image-1'> </a> 
            //                                        <nav class='u-menu u-menu-dropdown u-offcanvas u-menu-1'>
